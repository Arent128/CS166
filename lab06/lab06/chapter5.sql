...
\COPY suppliers(sid,sname,address) FROM 'suppliers.txt' WITH DELIMITER ';';

\COPY parts(pid,pname,color) FROM 'parts.txt' WITH DELIMITER ',';

\COPY catalog(sid,pid,cost) FROM 'catalog.txt' WITH DELIMITER ',';
